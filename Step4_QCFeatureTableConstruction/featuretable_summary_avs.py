...
print("Loading AVS files...")
clustered_table = Artifact.load('table.qza')
clustered_sequences = Artifact.load('rep-seqs.qza')
...
table_viz.save('table-summary.qzv')
...
seq_viz.save('rep-seqs-summary.qzv')

print("Done! created 'table-summary.qzv' and 'rep-seqs-summary.qzv'")